/**
 * 
 * Custom MK3S with modified Z height.
 * This config is set the printer type to MK3 with the MK3S filament sensor
 * 
 * */
...
#define TMC2130_TCOOLTHRS_E 600       // TCOOLTHRS - coolstep treshold
